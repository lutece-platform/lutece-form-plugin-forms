...
(101,'Bouton radio',0,0,0,'forms.entryTypeRadioButton','dot-circle-o','forms');
INSERT INTO genatt_entry_type (id_type,title,is_group,is_comment,is_mylutece_user,class_name,icon_name,plugin) VALUES 
(102,'Case à cocher',0,0,0,'forms.entryTypeCheckBox','check-square-o','forms');
INSERT INTO genatt_entry_type (id_type,title,is_group,is_comment,is_mylutece_user,class_name,icon_name,plugin) VALUES 
(103,'Commentaire',0,1,0,'forms.entryTypeComment','comment-o','forms');
INSERT INTO genatt_entry_type (id_type,title,is_group,is_comment,is_mylutece_user,class_name,icon_name,plugin) VALUES 
(104,'Date',0,0,0,'forms.entryTypeDate','calendar','forms');
INSERT INTO genatt_entry_type (id_type,title,is_group,is_comment,is_mylutece_user,class_name,icon_name,plugin) VALUES 
(105,'Liste déroulante',0,0,0,'forms.entryTypeSelect','list-alt','forms');
INSERT INTO genatt_entry_type (id_type,title,is_group,is_comment,is_mylutece_user,class_name,icon_name,plugin) VALUES 
(106,'Zone de texte court',0,0,0,'forms.entryTypeText','file-text-o','forms');
INSERT INTO genatt_entry_type (id_type,title,is_group,is_comment,is_mylutece_user,class_name,icon_name,plugin) VALUES 
(107,'Zone de texte long',0,0,0,'forms.entryTypeTextArea','file-text','forms');
INSERT INTO genatt_entry_type (id_type,title,is_group,is_comment,is_mylutece_user,class_name,icon_name,plugin) VALUES 
(108,'Fichier',0,0,0,'forms.entryTypeFile','file','forms');
INSERT INTO genatt_entry_type (id_type,title,is_group,is_comment,is_mylutece_user,class_name,icon_name,plugin) VALUES
(109,'Géolocalisation',0,0,0,'forms.entryTypeGeolocation','map-o','forms');
INSERT INTO genatt_entry_type (id_type,title,is_group,is_comment,is_mylutece_user,class_name,icon_name,plugin) VALUES
(110,'Image',0,0,0,'forms.entryTypeImage','image','forms');
INSERT INTO genatt_entry_type (id_type,title,is_group,is_comment,is_mylutece_user,class_name,icon_name,plugin) VALUES
