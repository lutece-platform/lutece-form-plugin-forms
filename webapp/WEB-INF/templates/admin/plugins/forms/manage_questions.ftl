                                        ...
                                        <tr <#if group>class="group"</#if>>
                                            ...
                                            <td class="col-xs-10 col-sm-6 <#if group>bg-gray</#if>">
                                                ...
                                                <div class="visible-xs">
                                                    <@aButton href='jsp/admin/plugins/forms/ManageQuestions.jsp?view=getConfirmRemoveComposite&id_step=${step.id}&id_display=${composite.formDisplay.id}' title='#i18n{forms.manage_questions.action.removeQuestion}' buttonIcon='trash' color='btn-link text-danger' />
                                                    <#if group>
                                                        <@aButton href='jsp/admin/plugins/forms/ManageQuestions.jsp?view=modifyGroup&id_step=${step.id}&id_group=${composite.formDisplay.compositeId}' title='#i18n{forms.manage_questions.action.modifyGroup}' buttonIcon='pencil' color='btn-link' />
                                                    <#else>
                                                        <@aButton href='jsp/admin/plugins/forms/ManageQuestions.jsp?view=modifyQuestion&id_step=${step.id}&id_question=${composite.formDisplay.compositeId}' title='#i18n{forms.manage_questions.action.modifyQuestion}' buttonIcon='pencil' color='btn-link' />
                                                        <@aButton href='jsp/admin/plugins/forms/ManageControls.jsp?view=modifyConditionControl&id_display=${composite.formDisplay.id}&id_step=${step.id}' class='btn-iframe' title='#i18n{forms.manage_questions.action.condition}' buttonIcon='question' color='btn-link' />
                                                    </#if>
                                                    ...
                                                    <@aButton href='jsp/admin/plugins/forms/ManageControls.jsp?view=manageControl&id_step=${step.id}&id_target=${composite.formDisplay.compositeId}&control_type=VALIDATION' class='btn-iframe'  title='#i18n{forms.manage_questions.action.control}' params=group?then('style="visibility:hidden;"','') buttonIcon='check' color='btn-link' />
                                                </div>
                                            </td>                               
                                            ...
                                            <td class="hidden-xs col-sm-4 <#if group>bg-gray</#if>">
                                                <@aButton href='jsp/admin/plugins/forms/ManageQuestions.jsp?view=getConfirmRemoveComposite&id_step=${step.id}&id_display=${composite.formDisplay.id}' title='#i18n{forms.manage_questions.action.removeQuestion}' buttonIcon='trash' color='btn-link' class='text-danger' /> 
                                                <#if group>
                                                    <@aButton href='jsp/admin/plugins/forms/ManageQuestions.jsp?view=modifyGroup&id_step=${step.id}&id_group=${composite.formDisplay.compositeId}' title='#i18n{forms.manage_questions.action.modifyGroup}' buttonIcon='pencil' color='btn-link' />
                                                <#else>
                                                    <@aButton href='jsp/admin/plugins/forms/ManageQuestions.jsp?view=modifyQuestion&id_step=${step.id}&id_question=${composite.formDisplay.compositeId}' title='#i18n{forms.manage_questions.action.modifyQuestion}' buttonIcon='pencil' color='btn-link' />
                                                ...
                                                <@aButton href='jsp/admin/plugins/forms/ManageQuestions.jsp?view=moveComposite&id_step=${step.id}&id_display=${composite.formDisplay.id}' class='btn-iframe' title='#i18n{forms.manage_questions.action.move}' buttonIcon='arrows-alt' color='btn-link' />
                                                <@aButton href='jsp/admin/plugins/forms/ManageControls.jsp?view=manageControl&id_step=${step.id}&id_target=${composite.formDisplay.compositeId}&control_type=VALIDATION' class='btn-iframe'  title='#i18n{forms.manage_questions.action.control}' params=group?then('style="visibility:hidden;"','') buttonIcon='check' color='btn-link' />
                                                <@aButton href='jsp/admin/plugins/forms/ManageQuestions.jsp?action=duplicateQuestion&id_step=${step.id}&id_target=${composite.formDisplay.compositeId}' class='btn-into'  title='#i18n{forms.manage_questions.action.copy}' params=group?then('style="visibility:hidden;"','') buttonIcon='copy' color='btn-link' />
                                            </td>
