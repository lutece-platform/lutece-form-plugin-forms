    ...
    <fieldset>
        ...
        <@table>
			...
			<tr>
                ...
                <#nested>
				<td>                       
                    <@aButton href='jsp/admin/plugins/forms/ModifyEntry.jsp?view=modifyField&id_question=${question.id}&id_field=${field.idField}&option_no_display_title=true' title='#i18n{portal.util.labelModify}' buttonIcon='pencil' showTitle=false color='btn-link' />
                    <#if cpt!=1>
                        <@aButton href='jsp/admin/plugins/forms/ModifyEntry.jsp?action=moveFieldUp&id_question=${question.id}&id_field=${field.idField}#list' title='#i18n{forms.createEntry.manageField.titleMoveUp}' buttonIcon='chevron-up' showTitle=false color='btn-link' />
                    </#if> 
                    <#if field_has_next>
                        <@aButton href='jsp/admin/plugins/forms/ModifyEntry.jsp?action=moveFieldDown&id_question=${question.id}&id_field=${field.idField}#list' title='#i18n{forms.createEntry.manageField.titleMoveDown}' buttonIcon='chevron-down' showTitle=false color='btn-link' />
                    </#if>
                    <@aButton href='jsp/admin/plugins/forms/ModifyEntry.jsp?view=confirmRemoveField&id_question=${question.id}&id_field=${field.idField}#list' title='#i18n{forms.createEntry.manageField.titleDelete}' buttonIcon='trash' showTitle=false color='btn-link text-danger' />
                </td>
			</tr>
			</#list> 
                ...
                <@table>
                    ...
                    <#list entry.fields as field>
                        ...
                        <tr>
                            ...
                            <td>
                                <@aButton href='jsp/admin/plugins/forms/DoRemoveVerification.jsp?id_expression=${expression.idExpression}&id_field=${idField}#list' title='#i18n{forms.createEntry.manageField.titleDelete}' showTitle=false buttonIcon='trash' color='btn-danger' />
                            </td>
                        </tr>
                        </#list>
                    </#list>
