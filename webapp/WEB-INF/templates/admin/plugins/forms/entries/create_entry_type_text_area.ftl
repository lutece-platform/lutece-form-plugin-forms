		...
		<@tform action='jsp/admin/plugins/forms/ManageQuestions.jsp'>
			<fieldset>
				...
				<@formGroup labelFor='value' labelKey='#i18n{forms.createEntry.labelValueDefault}'>
					<@input type='textarea' name='value' id='value'></@input>
				</@formGroup>
				...
				<@formGroup labelFor='width' labelKey='#i18n{forms.createEntry.labelWidth}' mandatory=true>
					<@input type='text' name='width' id='width' value=getName('width_text_area',list_param_default_values) />
				</@formGroup>
				<@formGroup labelFor='height' labelKey='#i18n{forms.createEntry.labelHeight}' mandatory=true>
					<@input type='text' name='height' id='height' value=getName('height_text_area',list_param_default_values) />
				</@formGroup>
				...
				<@formGroup helpKey='#i18n{forms.createEntry.labelUseRichTextComment}'>
					<@checkBox labelFor='css_class' labelKey='#i18n{forms.createEntry.labelUseRichText}' name='useRichText' value='true' />
				</@formGroup>
