				...
				<@tform action='jsp/admin/plugins/forms/ManageQuestions.jsp'>
                    ...
                    <input name="id_question" value="${question.id}" type="hidden" />
						...
						<@formGroup>
							...
							<@button type='button' buttonIcon='close' title='#i18n{forms.modifyEntry.buttonCancel}' showTitleXs=false color='btn-default' params='onclick="javascript:window.history.back();"' size='' />
						</@formGroup>
					</fieldset>
				</@tform>
			</@boxBody>
