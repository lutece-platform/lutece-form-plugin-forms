	...
	<@boxBody>
		<@tform action='jsp/admin/plugins/forms/ManageQuestions.jsp'>
			<fieldset>
				...
				<@formGroup labelFor='mandatory' labelKey='#i18n{forms.createEntry.labelType} : ${entry.entryType.title}'>
					<@checkBox labelFor='mandatory' labelKey='#i18n{forms.createEntry.labelMandatory}' name='mandatory' id='mandatory' value='1' checked=getChecked('mandatory',list_param_default_values) />
				</@formGroup>
