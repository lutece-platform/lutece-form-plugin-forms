        ...
        <@tform method="post" name="manage_entries" action="jsp/admin/plugins/forms/ManageQuestions.jsp">
            <fieldset>
                ...
                <@formGroup labelFor='width' labelKey='#i18n{forms.createEntry.labelWidth}' mandatory=true>
                    <@input type='text' name='width' id='width' value=getName('width_text',list_param_default_values,'0') />
                </@formGroup>
                ...
                <@formGroup>
                    <@checkBox labelFor='confirm_field' labelKey='#i18n{forms.createEntry.labelConfirmField}' name='confirm_field' id='confirm_field' value='1' params='onchange="javascript:changeVisilityConfirmFieldTitle();"' />
                </@formGroup>
                ...
                <@formGroup>
                    <@button type='submit' name='action_createQuestion' buttonIcon='save' title='#i18n{forms.modifyEntry.buttonSave}' size='' />
                    <@aButton href='jsp/admin/plugins/forms/ManageQuestions.jsp?id_step=${step.id}' buttonIcon='close' title='#i18n{forms.createEntry.buttonCancel}' size='' color='btn-secondary' />
                </@formGroup>
            </fieldset>
        </@tform>
    </@boxBody>
