        ...
        <@box color='primary' collapsed=true params='style="margin-bottom:0;"'>
            <@boxHeader title='#i18n{forms.manageForm.title}' boxTools=true>
                <#if permission_create_forms>
                    <@aButton href='jsp/admin/plugins/forms/ManageForms.jsp?view=createForm' buttonIcon='plus  text-success' title='#i18n{forms.manageForm.buttonAdd}' color='btn-link' />
                </#if>
            </@boxHeader>
        </@box>
        <@box color='solid'>
                            ...
                            <td class="col-xs-12 col-sm-3">
                                <#if form.actions?exists>
                                    <#list form.actions as action>
                                        ...
                                        <@aButton href='${action.url}&id_form=${form.id}' title='${action.name}' class='${color} ${action.permission?lower_case}' buttonIcon=action.iconUrl color='btn-link' params=params />
                                    </#list>
                                </#if>
                                <#if form.active>
